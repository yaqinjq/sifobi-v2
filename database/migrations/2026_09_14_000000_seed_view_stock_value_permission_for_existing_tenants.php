 ...
 * permission baru (view_stock_value, ditambahkan ke TenantRoleSeeder di komit
 * d5aa0a6) tidak otomatis sampai ke tenant yang sudah ada hanya lewat
 * `artisan migrate` -- deploy.sh tidak pernah menjalankan seeder.
 */
