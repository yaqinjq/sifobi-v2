...
class ItemInstructionSheet implements FromArray, ShouldAutoSize, WithStyles, WithTitle
{
    public function array(): array
    {
        return [
            ...
            ['item_jenis', 'Nama/kode Jenis Bahan yang SUDAH ADA di Pengaturan > Jenis Bahan (tidak dibuat otomatis). Kosongkan kalau belum tahu, isi belakangan lewat Edit Item.', 'Raw Material', 'Tidak'],
