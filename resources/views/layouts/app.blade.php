...
<body class="h-full bg-gray-50 font-sans antialiased">
    ...
    <aside class="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:flex lg:w-64 lg:flex-col bg-primary-800">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
            @php
            $sidebarNav = [
                ['route' => 'dashboard',                    'label' => 'Dashboard',         'pattern' => 'dashboard',                    'icon' => 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6'],
                ['route' => 'operations.open-stocks.index', 'label' => 'Open Stock',        'pattern' => 'operations.open-stocks.*',     'icon' => 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4'],
                ['route' => 'stock.balance.index', 'label' => 'Stok Gudang', 'pattern' => 'stock.balance.*', 'permission' => 'view_stock_balance', 'icon' => 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4'],
                ['route' => 'operations.opname.index', 'label' => 'Opname', 'pattern' => 'operations.opname.*', 'permission' => 'input_opname', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4'],
                ['route' => 'operations.spoil-wastes.index', 'label' => 'Spoil & Waste', 'pattern' => 'operations.spoil-wastes.*', 'permission' => 'record_spoil', 'icon' => 'M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16'],
                ['route' => 'receiving.goods-receipts.index', 'label' => 'Penerimaan Barang', 'pattern' => 'receiving.goods-receipts.*', 'permission' => 'view_goods_receipt', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414A1 1 0 0119 9.414V19a2 2 0 01-2 2z'],
            ];
            @endphp
