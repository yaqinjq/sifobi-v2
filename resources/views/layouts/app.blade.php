    ...
    <aside class="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:flex lg:w-64 lg:flex-col bg-primary-800">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
            ...
            $sidebarNav = [
                ...
                ['route' => 'stock.balance.index', 'label' => 'Gudang', 'pattern' => 'stock.balance.*', 'permission' => 'view_stock_balance', 'icon' => 'M3 21h18M3 7v14M21 7v14M6 21V7m6 14V7m6 14V7M3 7l9-4 9 4'],
