    ...
    <aside class="hidden lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:flex lg:w-64 lg:flex-col bg-primary-800">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
            ...
            $sidebarNav = [
                ...
                ['route' => 'operations.stock-transfers.index', 'label' => 'Transfer Stok',  'pattern' => 'operations.stock-transfers.*', 'permission' => 'create_stock_transfers', 'icon' => 'M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4',                                                         'badge_key' => 'transfer_pending'],
                ['route' => 'procurement.purchase-orders.index', 'label' => 'Purchase Order', 'pattern' => 'procurement.purchase-orders.*', 'permission' => 'create_po', 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01', 'badge_key' => null],
            ];
            @endphp
