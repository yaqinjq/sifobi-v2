...
@section('content')
<x-sf.page-header title="Buat Transfer Stok" subtitle="Pindahkan stok antar outlet" back="{{ route('stock.transfers.index') }}" />
...
<div class="px-4 py-5 pb-24 lg:px-6 lg:py-6 max-w-3xl mx-auto w-full"
    ...
    <form method="POST" action="{{ route('stock.transfers.store') }}" @submit.prevent="submitForm">
        @csrf
