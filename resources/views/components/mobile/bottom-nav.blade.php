    ...
    <div class="flex h-16">
        ...
        $navItems = $canPo
            ...
            : [
                ...
                [
                    'href'    => $canMaster ? route('master-data.items.index') : '#',
                    'label'   => $canMaster ? 'Master' : 'Profil',
                    'pattern' => $canMaster ? 'master-data.*' : 'profile.*',
                    'icon'    => $canMaster ? 'M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4' : 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z',
                ],
            ];
        @endphp
